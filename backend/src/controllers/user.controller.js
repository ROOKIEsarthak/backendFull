...
const registerUser = asyncHandler(async (req, res) => {
  ...
  /* One way is to apply if statement on all the fields like this
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  /* NOTE -: here is a small note about the user instances in the code i.e. (user and User) and what and which to use with whom.
    ...
    ------->>> the " user " instance is a method created by us to handle and use all the data coming from the
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  //TODO : delete old image - you have to create a new utility function and give avatar url back to it
